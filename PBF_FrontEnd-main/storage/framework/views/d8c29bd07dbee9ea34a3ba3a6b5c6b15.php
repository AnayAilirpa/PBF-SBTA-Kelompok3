...
<ul class="nav nav-pills flex-column mb-auto h-full">
  <li class="nav-item">
    <a href="<?php echo e(route('home')); ?>" class="nav-link link-body-emphasis">
  ...
  <li>
    <a href="<?php echo e(route('dosen.dosen')); ?>" class="nav-link link-body-emphasis">
  ...
  <li>
    <a href="<?php echo e(route('mahasiswa.mahasiswa')); ?>" class="nav-link link-body-emphasis">
  ...
  <li>
    <a href="<?php echo e(route('tugas_akhir.tugas_akhir')); ?>" class="nav-link link-body-emphasis">
    <img src="image/book.png" alt="Icon" width="19" height="19" class="pe-none me-2">
      Tugas Akhir
    </a>
  </li>
  <li>
    <a href="<?php echo e(route('bimbingan.bimbingan')); ?>" class="nav-link link-body-emphasis">
...
<?php /**PATH C:\xampp\htdocs\PBF-SBTA-Kelompok3\PBF_FrontEnd-main\resources\views/sidebar.blade.php ENDPATH**/ ?>